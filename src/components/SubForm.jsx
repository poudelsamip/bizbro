...
//       {/* Quantity Input (Shrinks if needed) */}
//       <div className="flex-1">
//         <label htmlFor={quantityId} className="text-xs text-gray-300">
//           Quantity
//         </label>
//         <input
//           type="number"
...
//       {/* Total Price Input (Shrinks if needed) */}
//       <div className="flex-1">
