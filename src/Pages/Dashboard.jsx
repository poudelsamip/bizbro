...
//       <h1 className="text-4xl font-bold mb-6 text-gray-50">Dashboard</h1>

//       {/* Summary Cards */}
//       <h1 className="text-2xl font-semibold text-gray-50">This Month</h1>
...
const Dashboard = () => {
  ...
  // Calculate daily sales trend - FIXED VERSION
  const dailySalesTrend = [];
  ...
  // Then extract days only from current month transactions
  const dates = [
    ...new Set(
  ...
  // Create daily sales data using only current month transactions
  dates.forEach((day) => {
