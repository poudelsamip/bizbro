...
//       backgroundColor: "white", // Ensure white background for black & white PDF
//     });
...
//     // Get the width and height of the A4 page in pixels
//     const pdfWidth = pdf.internal.pageSize.getWidth();
//     const pdfHeight = pdf.internal.pageSize.getHeight();

//     // Scale the image to fit the PDF size, keeping the aspect ratio
//     const imgWidth = pdfWidth - 20; // 20px margin from the left
